            ...
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              {postedBy?._id === user.sub && (
                <button
                  ...
                  type="button"
                  className="bg-white p-2 opacity-50 hover:opacity-100 text-dark font-bold text-base rounded-3xl hover:shadow-md outline-none "
                >
                  <AiTwotoneDelete />
                </button>
              )}
